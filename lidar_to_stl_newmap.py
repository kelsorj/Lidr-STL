...
NEW MAP SECTION - Uses separate folders from main project.
...
# CONFIGURATION
# -----------------------------------------------------------
LAZ_LIST_FILE = "downloadlist.txt"  # New map download list
LAZ_DIR = "newmap_lidar_laz"        # Separate folder for new map
MERGED_DEM = "newmap_lidar_merged.tif"
OUTPUT_DIR = "stl_tiles_newmap"
...
print("=" * 60)
print("🗺️  NEW MAP - LiDAR to STL Converter")
print("=" * 60)
...
for batch_idx in range(num_batches):
    ...
    batch_dem = f"newmap_batch_{batch_idx}.tif"
    ...
    pipeline_path = f"newmap_pipeline_batch_{batch_idx}.json"
...
for tile_y in range(num_tiles_y):
    for tile_x in range(num_tiles_x):
        ...
        # Export
        output_file = os.path.join(OUTPUT_DIR, f"newmap_tile_{tile_x}_{tile_y}.stl")
